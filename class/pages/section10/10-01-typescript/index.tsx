export default function TypescriptPage() {
  // 타입추론 : 처음 들어간 값의 타입으로 지정해버려 : string 따로 명시해주지 않아도 된다.
  let aaa = "안녕하세요"
  aaa = 3
  ...
  // 함수타입
  // 함수타입은 타입추론이 안되기 때문에 반드시 타입명시를 해줘야 함.
  function add(num1: number, num2: number, unit: string): string {
    return num1 + num2 + unit
  }
  const result1 = add(1000, 2000, "원") // 결과의 리턴 타입도 예측 가능!
