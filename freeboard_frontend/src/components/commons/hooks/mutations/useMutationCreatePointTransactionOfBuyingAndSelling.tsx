...
export default function useMutationCreatePointBuying() {
  ...
  const [createPointBuying] = useMutation<Pick<IMutation, "createPointTransactionOfBuyingAndSelling">, IMutationCreatePointTransactionOfBuyingAndSellingArgs>(CREATE_POINT_BUYING)
